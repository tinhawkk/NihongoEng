...
const missingLogic = `                  <circle cx={cx - 3.5} cy="91.5" r="3.2" fill="white" />
...
c = c.replace(/{\/\* 3-Point Sparkle Highlights \*\/}\s+}}/, '{\/* 3-Point Sparkle Highlights */}\n' + missingLogic + ' }');

fs.writeFileSync(p, c);
console.log('Restored PomodoroCat.jsx');
